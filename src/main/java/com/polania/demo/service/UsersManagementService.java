...
import com.polania.demo.modelDTO.ReqRes;
...
public class UsersManagementService {
    ...
    public ReqRes register(ReqRes registrationRequest){
        ...
        try {
            ...
            if (ourUsersResult.getId()>0) {
                resp.setUsuario(ourUsersResult);
    ...
    public ReqRes refreshToken(ReqRes refreshTokenReqiest){
        ...
        try{
            ...
            Usuario users = usersRepo.findByUsername(username).orElseThrow();
    ...
    public ReqRes getMyInfo(String username){
        ReqRes reqRes = new ReqRes();
        try {
            Optional<Usuario> userOptional = usersRepo.findByUsername(username);
            if (userOptional.isPresent()) {
